                    ...
                    <template>
                      <div class="has-text-left">
                        ...
                        <template v-if="currentUser.is_staff">
                          ...
                          <b-dropdown-item @click="toggleHighlight()">
                            <template v-if="thread.highlighted">
                              <b-icon icon="pin-off"></b-icon>Desactivar destacada
                            </template>
                            <template v-else>
                              <b-icon icon="pin"></b-icon>Destacar
                            </template>
                          </b-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    toggleHighlight() {
      let payload = { highlighted: !this.thread.highlighted };
      this.makePetition(Forum.updateThread(this.id, payload)).then(thread => {
        this.thread.highlighted = payload.highlighted;
      });
    },
    toggleLock() {
