          ...
          <div class="columns is-mobile is-multiline">
            <div class="column is-2-tablet is-6-mobile">
              <figure class="image is-256x256">
                ...
                <div
                  v-if="editing && !cropImageSelected"
                  @click="crop.chooseFile()"
            ...
            <div class="column is-4-tablet is-6-mobile name" v-if="!editing">
              <p>
                <span class="title is-bold">
                  ...
                  <div
                    v-if="currentUser && currentUser.username !== profileUser.username"
              ...
              <div v-if="currentUser">
                <template v-if="currentUser.id == profileUser.id">
                  <a v-if="!editing" @click="startEdit()" class="button is-primary">Editar perfil</a>
              ...
              <div class="columns">
                <div class="column is-12">
                  <div class="field is-grouped">
                    <p class="control">
                      <a class="button is-info" @click="saveEdit()">Guardar</a>
                    </p>
                    <p class="control">
                      <a class="button is-danger" @click="cancelEdit()">Cancelar</a>
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.makePetition(FigureSite.getUser(this.username), true, true).then(
        username => {
      ...
      return new Promise((resolve, reject) => {
        ...
        this.crop.promisedBlob("image/jpeg").then(blob => {
          ...
          this.$awn
            .async(
              this.makePetition(
                FigureSite.updateUserAvatar(this.username, data, options)
              ),
    ...
    updateProfile() {
      ...
      this.$awn.async(
        this.makePetition(
          FigureSite.updateUser(this.username, this.profileUser)
        ),
        "Perfil actualizado corractualizado correctamente.",
